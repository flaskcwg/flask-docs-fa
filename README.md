...
مطمئنا نرم افزار‌های دیگری نیز برای ویرایش فایل های `po` وجود دارد. برخی از آن برنامه ها را می‌توانید از [اینجا](https://alternativeto.net/software/better-po-editor/) بیابید

> __**نکته:**__ استفاده از نرم افزار برای ترجمه الزامی نیست و می‌توانید از یک ویرایشگر متن هم استفاده کنید
...
* [ ] reqcontext
* [ ] security
* [X] server [@Abol-010](https://github.com/Abol-010)Abol-010
